	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="active"><a href="tickets.php"><i class="icon icon-warning-sign"></i> <span>Notificações</span> <span class="label" style="background-color: #800;"><?php echo $admpanel->ticketnr($conn); ?></span><span class="label" style="background-color: #f89406;"><?php echo $admpanel->ticketnotsolved($conn); ?></span></a></li>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="tickets.php" class="current">Notificações</a>
			</div>
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						     <?php $admpanel->markallsolved($conn);  ?>
						<div class="pull-right">
						<form method="post">
						<button name="allread" type="submit" class="btn btn-inverse"><i class="icon-white icon-retweet"></i> Marcar tudo resolvido</button>
						</form>
										<br/></div>
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table">
									...
									<th style="width: 47%;">Assunto <i class=" icon-sort"> </i></th>
									<th style="width: 20%;">Enviado por <i class=" icon-sort"> </i></th>
									<th style="width: 15%;">Enviada em <i class=" icon-sort"> </i></i></th>
									<th style="width: 18%;">Opções</i></th>
									</tr>
									</thead>
									<tbody>
									<?php $admpanel->ticketlist($conn); ?>
									</tbody>
									</table>  
							</div>
						</div>
