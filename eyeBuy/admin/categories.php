	...
	<body>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="categories.php" class="current">Categorias</a>
			</div>
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<?php $admpanel->newcat($conn); ?>
						<div class="widget-box">
							<div class="widget-title">
								<span class="icon">
									<i class="icon-align-justify"></i>									
								</span>
								<h5>Criar nova categotria</h5>
							</div>
							<div class="widget-content nopadding">
								<form method="post" class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
											<input name="newcat" type="text" /> <button style="margin-left:20px;" name="submit" type="submit" class="btn btn-primary"> Guardar</button>
										</div>
									</div>
								</form>
							</div>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table table-striped with-check">
									<thead>
									<tr>
									<th style="width: 35%;">Nome <i  class=" icon-sort"> </i></th>
									<th style="width: 10%;">Subcategorias <i  class=" icon-sort"> </i></th>
