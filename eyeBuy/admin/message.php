                        ...
                        <div id="gritter-item-2" class="gritter-item-wrapper" >
                            <div class="gritter-item">
                                <div class="gritter-without-image">
                                    <span class="gritter-title">Mensagem enviada!</span>
                                    <p>Para voltar à caixa de entrada clique <a href="inbox.php">aqui</a>.</p>
                                </div>
                            </div>
                         </div>
                    </div>';
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
							...
							<div class="widget-box">
								<div class="widget-title">
									<span class="icon">
										...
										<h5>De: <?php echo $msg["origem"]; ?>              Assunto: <?php echo $msg["assunto"]; ?></h5> <div class="pull-right"><h5> <?php echo $msg["time"]; ?></h5>  </div>
									</div>
						...
						<div class="span2"><br/><form method="post" action="<?php $admpanel->markunread($conn); ?>"><button name="unread" type="submit" class="btn btn-inverse" style="width:100%;"><i class="icon-white icon-retweet"></i>  Marcar não-lida</button> </form> 
						...
						<br/><a href="#collapseTwo" data-toggle="collapse" ><button class="btn btn-primary" style="width:100%;"><i class="icon-pencil icon-white"></i> Responder</button></a>
						</div>
