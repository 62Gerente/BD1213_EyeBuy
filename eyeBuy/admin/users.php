	...
	<body>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="users.php" class="current">Utilizadores</a>
			</div>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table">
									<thead>
									<tr>
									<th style="width: 25%;">Utilizador <i class=" icon-sort"> </i></th>
									<th style="width: 20%;">Nome <i class=" icon-sort"> </i></th>
									<th style="width: 25%;">E-mail <i class=" icon-sort"> </i></th>
									<th style="width: 10%;">Comprador <i class=" icon-sort"> </i></th>
									<th style="width: 10%;">Vendedor <i class=" icon-sort"> </i></th>
									<th style="width: 10%;">Opções</th>
									</tr>
									</thead>
									<tbody>
									<?php $admpanel->getusers($conn); ?>
									</tbody>
									</table>  
							</div>
						</div>
