	...
	<body>
		...
		<div id="content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12"><?php $admpanel->deleteall($conn); ?>
						<div class="pull-right">
						<form method="post">
						<button name="deleteall" type="submit" value="2" class="btn btn-danger"><i class="icon-white icon-remove"></i> Apagar todas</button></form>
										<br/></div>
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table">
									...
									<th style="width: 20%;">Enviado para <i class=" icon-sort"> </i></th>
									<th style="width: 15%;">Enviada em <i class=" icon-sort"> </i></th>
									<th style="width: 15%;">Opções</i></th>
									</tr>
									</thead>
									<tbody>
									<?php $admpanel->msglistsent($conn); ?>
									</tbody>
									</table>  
							</div>
						</div>
